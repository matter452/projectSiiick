...
function TopLevelLinks({ list })
{
    return(
    <div>
        <ul>
            {list.map((item) => {<li className='text-black font-bold'><a href=''>{item}</a></li>})}
        </ul>
    </div>)
}

function SideFilters({ filtersList })
{
    return(
        <div>
...
export default function SideFilter({products}) {
