...
function FormInformation({infoType}){
    return (
        <>
        <Fieldset className="w-fit space-y-4 bg-white my-2 py-8">
            ...
            <Fieldset className="w-fit space-y-4 bg-white rounded-lg my-2 py-8">
                ...
                <Field className="block">
                    ...
                    placeholder="1234 5678 9012 3456">
                        {(inputProps) => <Input className="block" {...inputProps} type="text" />}
                ...
                <div className='flex flex-row'>
                    <Field className="">
                        ...
                        placeholder="01 / 23">
                            {(inputProps) => <Input className="block max-w-36" {...inputProps} type='text' />}
                        </InputMask>
                    </Field>
                ...
                <Fieldset className={`${isHidden}`} disabled={isDisabled}>
                    <FormInformation infoType={"Billing"} />
                </Fieldset>
            </Fieldset>
        </>
    )
...
export default function Page(){
    ...
    return(
        ...
        <section className='flex flex-col text-black space-y-2'>
        <form action="post">
        ...
        <section className='flex flex-col w-1/3 space-y-2 px-16 mt-4 text-neutral-700'>
            ...
            <Link href={'checkout/order/success'}><button className="border rounded-full text-neutral-50 font-semi-bold bg-zinc-950 p-2 px-4 mt-4 hover:bg-zinc-700">Place Order</button></Link>
